CREATE DATABASE IF NOT EXISTS `mcp_oauth_center` DEFAULT CHARACTER SET = utf8mb4;
Use `mcp_oauth_center`;
...
CREATE TABLE `oauth_client_details`  (
  ...
  `autoapprove` char(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'true' COMMENT '是否自动授权 是-true',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  `client_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '应用名称',
