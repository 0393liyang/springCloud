CREATE DATABASE IF NOT EXISTS `mcp_xxl_job` DEFAULT CHARACTER SET = utf8mb4mb4;
Use `mcp_xxl_job`;
...
CREATE TABLE `XXL_JOB_QRTZ_TRIGGER_REGISTRY`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `registry_group` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
